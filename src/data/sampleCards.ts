...
const nonDiscriminatingCards: DiscriminatingCard[] = [
  {
    ...
    explanation:
      'Patients would report improvement in all three scenarios. Without a control group, we cannot distinguish whether MAT itself caused the improvement, or whether patients would have felt better anyway.',
  ...
  },
  {
    ...
    correctClassification: 'non-discriminating',
    explanation:
      'Producing human-like responses is equally expected under all three hypotheses. The Turing test measures output quality, not the underlying mechanism. A very good pattern matcher would pass too.',
    tag: 'Confirmatory but non-discriminating',
    difficulty: 2,
  },
  {
  ...
  },
  {
    ...
    correctClassification: 'non-discriminating',
    explanation:
      'This observational finding is consistent with all three explanations. People who choose healthier diets often exercise more, smoke less, and have other healthy habits. We can\'t isolate the diet\'s effect.',
...
const buriedBaselineCards: BaselineCard[] = [
  {
    ...
    domain: 'health',
    scenario: 'A news report raises concerns about a new vaccine\'s safety.',
    claim: 'The Immunex vaccine causes blood clots.',
    evidence: 'Health authorities report that 47 people developed blood clots within two weeks of receiving the Immunex vaccine.',
    correctClassification: 'baseline-missing',
    theBaseline: 'We need to know: How many blood clots normally occur in this population in any two-week period? If 50 million people were vaccinated, 47 clots might be below the expected background rate.',
    explanation: 'Without knowing the baseline rate of blood clots, 47 sounds alarming but could actually be normal or even low. In large populations, rare events happen constantly—the question is whether they happen more than expected.',
    tag: 'Missing base rate',
    difficulty: 1,
  },
  {
    id: 'bb-2',
    category: 'buried-baseline',
    domain: 'everyday',
    scenario: 'A friend is amazed by a psychic\'s accurate prediction.',
    claim: 'Madame Zara has genuine psychic abilities.',
    evidence: 'Madame Zara told my friend she would "face a challenge at work and reconnect with someone from her past" — and both happened within a month!',
    correctClassification: 'baseline-missing',
    theBaseline: 'How often do working adults face job challenges and reconnect with old acquaintances anyway? Almost everyone experiences these regularly.',
    explanation: 'These predictions are so common they\'re nearly guaranteed. The "prophecy" would fit almost anyone\'s life in any given month. Specific, unlikely predictions (exact names, dates, unusual events) would be impressive; vague universal experiences are not.',
  ...
  },
  {
    ...
    category: 'buried-baseline',
    domain: 'science',
    scenario: 'An environmental group claims fracking is causing earthquakes in your region.',
    claim: 'Fracking operations are causing local earthquakes.',
    evidence: 'Since fracking began in the county, there have been 12 earthquakes within 10 miles of drilling sites.',
    correctClassification: 'baseline-missing',
    theBaseline: 'How many small earthquakes occurred in this area before fracking? Thousands of minor earthquakes happen daily worldwide. Without historical data, we can\'t know if 12 is unusual.',
    explanation: 'Without a baseline, we can\'t evaluate this claim. If the region previously had 15 earthquakes per year naturally, 12 might actually suggest fewer earthquakes. The relevant question is whether the rate increased.',
  ...
  },
  {
    ...
    category: 'buried-baseline',
    domain: 'policy',
    scenario: 'A city official claims their new policing strategy is reducing crime.',
    claim: 'Operation Safe Streets has made our city safer.',
    evidence: 'Since implementing Operation Safe Streets, violent crime is down 15% compared to the same period last year.',
    correctClassification: 'baseline-considered',
    theBaseline: 'The comparison to the same period last year provides a relevant baseline. This is a reasonable before/after comparison with the city as its own control.',
    explanation: 'This evidence properly considers the baseline by comparing to the previous year. While not perfect (other factors could explain the change), it\'s better than just citing current crime numbers without context.',
  ...
  },
  {
    ...
    category: 'buried-baseline',
    domain: 'medicine',
    scenario: 'A pharmaceutical company presents trial results for their new antidepressant.',
    claim: 'Sereniva is effective for treating major depression.',
    evidence: 'In the clinical trial, 52% of patients on Sereniva showed significant improvement, compared to 38% improvement in the placebo group.',
    correctClassification: 'baseline-considered',
    theBaseline: 'The placebo group provides the crucial baseline. The 38% placebo response shows how many would improve anyway, making the 14% additional improvement from Sereniva meaningful.',
    explanation: 'This properly accounts for base rates. Depression often improves on its own, and placebo effects are strong. By including a placebo comparison, we can see that Sereniva adds ~14% improvement beyond what happens naturally.',
    tag: 'Baseline considered',
    difficulty: 2,
  },
]
