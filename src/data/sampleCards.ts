...
const buriedBaselineCards: BaselineCard[] = [
  {
    ...
    baselineQuestion: 'What percentage of all children (not just autistic ones) received the MMR vaccine?',
    ...
    comparisonText: 'If 87% of autistic children got vaccinated, but 91% of all children got vaccinated, then autistic children are actually less vaccinated than average.',
    frameworkSee: '"X% of [group with outcome] had [exposure]"',
    frameworkAsk: '"What % of [everyone] had [exposure]?"',
    explanation: 'The 87% sounds alarming until you realize it\'s actually lower than the vaccination rate in the general population. If vaccines caused autism, you\'d expect a higher rate among autistic children, not a lower one.',
  ...
  },
  {
    ...
    baselineQuestion: 'How much do people improve on the same test just from practice, with no supplement at all?',
    ...
    comparisonText: 'If people normally improve 8-15 points just by retaking the test, then a 12-point improvement with NeuroBoost falls right within the normal range — the supplement may have done nothing.',
    frameworkSee: '"[group] improved by X after [intervention]"',
    frameworkAsk: '"How much does [group] improve without [intervention]?"',
    explanation: 'Cognitive tests have well-documented practice effects. Without a control group, a 12-point gain could be entirely normal.',
  ...
  },
  {
    ...
    baselineQuestion: 'What\'s the national average survival rate for bypass surgery?',
    ...
    comparisonText: 'If the national average for bypass surgery survival is 97-98%, then this hospital\'s 97.2% rate is right in the middle — average, not exceptional.',
    frameworkSee: '"Our [outcome] rate is X%"',
    frameworkAsk: '"What\'s the typical [outcome] rate everywhere else?"',
    explanation: 'Numbers sound impressive in isolation. A 97.2% survival rate feels exceptional until you learn that\'s just average for this procedure.',
  ...
  },
  {
    ...
    baselineQuestion: 'How many patients would improve without the drug (on placebo alone)?',
    ...
    comparisonText: 'The study already includes this: 31% improved on placebo vs. 52% on the drug. The baseline is built in, showing the drug adds about 21 percentage points of real benefit.',
    frameworkSee: '"X% improved with [treatment] vs. Y% with placebo"',
    frameworkAsk: 'The baseline is already here — the placebo group IS the comparison.',
    explanation: 'This is properly controlled evidence. The placebo comparison lets us see exactly how much the drug adds beyond natural improvement.',
