  ...
  <div class="w-full max-w-lg mx-auto px-4">
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
      ...
      <div
        ...
        :class="{
          'bg-green-50': props.classification === 'high-fidelity',
          'bg-purple-50': props.classification === 'low-fidelity',
        }"
      >
        <div class="flex items-center gap-2">
          <span v-if="props.classification === 'high-fidelity'" class="text-xl">&#10003;</span>
          <span v-else class="text-xl">~</span>
          <span
            class="font-medium"
            :class="{
              'text-green-700': props.classification === 'high-fidelity',
              'text-purple-700': props.classification === 'low-fidelity',
            }"
          >
            You said: {{ props.classification === 'high-fidelity' ? 'High Fidelity' : 'Low Fidelity' }}
          </span>
        </div>
      </div>
      ...
      <div class="p-6 space-y-5">
        ...
        <div>
          <h3 class="text-lg font-semibold text-gray-900 mb-2">
            {{ props.classification === 'low-fidelity' ? 'What makes this source unreliable?' : 'Why is this source trustworthy?' }}
          </h3>
        ...
        <textarea
          ...
          :placeholder="props.classification === 'low-fidelity' ? 'This source is unreliable because...' : 'This source is reliable because...'"
        />
